...
namespace EventManager3.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult ArtistResetPassword(string code = null)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ArtistResetPassword(ResetPasswordViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult UserResetPassword(string code = null)
        {
            return code == null ? View("Error") : View();
        }
        // new change
